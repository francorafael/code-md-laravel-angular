...
Route::get('project/{projectId}/member', 'ProjectMemberController@index');
Route::post('project/{projectId}/member', 'ProjectMemberController@store');
Route::get('project/{projectId}/member/{id}', 'ProjectMemberController@show');
Route::delete('project/{projectId}/member/{id}', 'ProjectMemberController@destroy');
